...
//		#TODO has error when up arrow is pressed in multi
		...
		public static final int TIGER2_WIDTH = 100;
		public static final int TIGER2_HEIGHT = 60;
		...
		public Player(MainApplication app) {
			...
			tigerImage.setSize(TIGER1_WIDTH,TIGER1_HEIGHT);
			tigerImage.setLocation(START_X, START_Y);
			program.add(tigerImage);
			
			tigerImage2 = new GImage("sounds/tiger_yellow.png");
			tigerImage2.setSize(TIGER2_WIDTH,TIGER2_HEIGHT);
			tigerImage2.setLocation(START_X+20, START_Y);
			program.add(tigerImage2);
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (tigerImage2.getY() == GROUND_Y && secondJump > 2){
				secondJump = 0;
			}
...
//			System.out.println(doubleJump);
		...
		public void p2jump() {
			// Normal Jump
			if (tigerImage2.getY() == GROUND_Y && continueGame == true && doubleJump == false) 	{
				tigerImage2.move(0, -jumpPower);
				secondJump = 0;
				System.out.println("SJ " + secondJump);
			}
			
			// DoubleJump
			if (tigerImage2.getY() == GROUND_Y && continueGame == true && doubleJump == true) {
				tigerImage2.move(0, -jumpPower);
			}
		...
		public void p2land() {
			if (tigerImage2.getY() < GROUND_Y) {
				tigerImage2.move(0, gravity);
			}
		}
